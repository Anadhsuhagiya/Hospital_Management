              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    }, icon: Icon(Icons.close,color: kBlack,size: h * 0.023,))
                  ],
                ),
                SizedBox(
                  height: h * 0.01,
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        onTap: () {
                          ...
                          // if(selectDate[0].isEmpty){
                            SelectDateIndex == index;
                            // selectDate.add(weekdayNames[DateTime.parse(dateList[index]).weekday - 1].substring(0, 3));
                          // }
                          // else{
                          //   SelectDateIndex == null;
                          // }
